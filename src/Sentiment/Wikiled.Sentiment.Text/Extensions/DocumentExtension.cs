...
namespace Wikiled.Sentiment.Text.Extensions
{
    public static class DocumentExtension
    {
        ...
        public static IList<SentimentDataItem> GetWordSentimentData(this Document document)
        {
            ...
            foreach (var sentence in document.Sentences)
            {
                foreach (var wordEx in sentence.Words)
                {
                    ...
                    var item = new SentimentDataItem(list.Count,
                        text,
        ...
        {
            return GetStyleDensity(document, sentenceLevel, tree == null ? new IDataItem[] { } : tree.AllLeafs.ToArray());
        }
        ...
        public static IList<double> GetStyleDensity(this Document document, bool sentenceLevel, IDataItem[] leafs)
        {
            ...
            return GetConditionDensity(document,
                                       sentenceLevel,
                                       wordItem =>
                                       {
                                           if (leafs.Length == 0)
        ...
        public static IList<double> GetSentimentCategoryDensity(this Document document,
                                                                bool sentenceLevel,
        ...
        public static IList<double> GetConditionDensity(this Document document,
                                                        bool sentenceLevel,
