...
namespace Wikiled.Sentiment.AcceptanceTests.Sentiments
{
    ...
    public class Word2VecTests
    {
        ...
        private static readonly SentimentTestData[] testData =
        {
            ...
            new SentimentTestData("B000ERAON2", 440, 0, "Total:<413> Positive:<84.401%> Negative:<70.370%> F1:<0.894> RMSE:1.40"),

            new SentimentTestData("B0026127Y8", 928, 0, "Total:<849> Positive:<79.818%> Negative:<71.605%> F1:<0.873> RMSE:1.38") { Category = ProductCategory.Video },
